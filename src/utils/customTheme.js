const theme = {
  button: {
    defaultProps: {
      ...
      fullWidth: false,
      ripple: true,
      className: "text-[10px] py-1 rounded-md text-center",
    },
    valid: {
    ...
    styles: {
      ...
      variants: {
        ...
        gradient: {
          ...
          green: {
            backgroud:
              "bg-gradient-to-tr from-emerald-500 to-emerald-700 border-2 border-emerald-600",
            color: "text-cream-100 capitalize",
            shadow: "shadow-md shadow-green-500/20",
