    ...
    return (
      <MaterialComponent component="SpeedDial">
        ...
        >
          ...
          <MaterialComponent
            component="SpeedDialAction"
            className="relative bg-transparent border-none hidden"
          >
            <ButtonComponent
              icon="HeartIcon"
      ...
      <MaterialComponent component="CardBody" className="w-full">
        <div className="flex flex-row items-start justify-between">
          <MaterialComponent
            ...
            as="div"
            color="white"
            className="font-bold capitalize mb-4 relative"
          ...
          >
            <Link
              onClick={() => handleLinkClick(post.post_link)}
              aria-label={`Open ${post.post_title} in a new tab.`}
              className="flex gap-2 items-top hover:text-lg hover:text-emerald-900 w-3/4 hover:w-5/6 duration-200"
            >
              {post.post_title}
            </Link>
          </MaterialComponent>
